...
{
  if (!$con->query("insert into useraccounts (name,pan,accountNo,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[pan]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        <tr>
          ...
          <th>PAN</th>
          <td><input type="number" name="pan" class="form-control input-sm" required></td>
        </tr>
        <tr>
